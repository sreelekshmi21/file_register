...
class ResponsiveApp:
    ...
    # if username_entry == "admin" and password == "password":
    ...
    #     messagebox.showerror("Login Failed", "Invalid username or password") 
        ...
        #View Register button with improved styling
        self.view_button = tk.Button(button_frame, text="SIGN UP", command=self.sign_up,
                             bg='#2196F3', fg='white', width=20, height=2,
                             font=self.button_font, relief=tk.RAISED,
                             activebackground='#0b7dda', cursor="hand2")
        self.view_button.grid(row=0, column=1, padx=20, pady=20)
    ...
    def open_signup_window(self):
        ...
        title_label.pack()
         ...
         # Create main frames
        input_frame = tk.Frame(new_signup_window, bg='#e6f2ff', padx=20, pady=20,
                                  highlightbackground='#99ccff', highlightthickness=1)
        input_frame.grid(row=1, column=0, columnspan=3, sticky="nsew", padx=40, pady=10)
        input_frame.grid_columnconfigure(0, weight=1)
        input_frame.grid_columnconfigure(1, weight=2)
        
        username = tk.Label(input_frame,text="Username")
        username.pack()

         
       
        self.username_entry_one = ttk.Entry(input_frame, width=40, font=self.label_font)
        self.username_entry_one.pack()
        # username_entry.grid(row=row, column=1, sticky="w", padx=10, pady=10)

        password = tk.Label(input_frame,text="password")
        password.pack()
        self.password_entry = ttk.Entry(input_frame, width=40, font=self.label_font)
        self.password_entry.pack()

        email = tk.Label(input_frame,text="email")
        email.pack()
        self.email_entry = ttk.Entry(input_frame, width=40, font=self.label_font)
        self.email_entry.pack()

        department = tk.Label(input_frame,text="department")
        department.pack()
        self.department_entry = ttk.Entry(input_frame, width=40, font=self.label_font)
        self.department_entry.pack()

        view_button = tk.Button(input_frame, text="SIGN UP", command=self.register,
                             bg='#2196F3', fg='white', width=20, height=2,
                             font=self.button_font, relief=tk.RAISED,
                             activebackground='#0b7dda', cursor="hand2")
        view_button.pack()
        ...
        back_to_login = tk.Button(input_frame, text="BACK TO LOGIN", command=self.back_to_login,
    ...
    def register(self):
        print("register")
        username = self.username_entry_one.get()
        print(username)
        password = self.password_entry.get()
        print(password)
    ...
    def open_treeview_window(self):
        ...
        add_btn = tk.Button(action_frame, text="ADD FILE INFO",
                            bg='#4CAF50', fg='white', font=self.button_font, padx=10)  #ADD btn
        ...
        def open_add_page(self):
         print("open afdd page")
         new_add_window = tk.Toplevel(self.root)
         new_add_window.title("File INFO")
        ...
        # action_frame = tk.Frame(content_frame, bg='#e6f2ff', pady=10)
        # action_frame.grid(row=3, column=0, sticky="ew")
        # add_btn = tk.Button(action_frame, text="SSSSSSSSSSSSSSSSSSSSS",
        #                     bg='#4CAF50', fg='white', font=self.button_font, padx=10)  #ADD btn
        # add_btn.pack(side=tk.LEFT, padx=10)
         ###########################################################################
        ...
        add_btn.config(command = open_add_page)
...
if __name__ == "__main__":
    ...
    # progress_bar.pack()
    # my_prog = ttk.Progressbar(root,orient='horizontal',length=100,mode="determinate" )
    ...
    # my_but = Button(root,text='Prohgress',command=step)
# def page2():
#     label=tk.Label(frame,text='this is the page2')
#     label.place(relx=0.3,rely=0.4)

# bt1=tk.Button(root,text='page2',command=root)
